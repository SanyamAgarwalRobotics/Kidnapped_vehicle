...
*/
for (iterationA = 0; iterationA < num_particles; iterationA++ ){
        Particle pt;
        pt.id = iterationA;
        pt.x = dist_x(gen);
        pt.y = dist_y(gen);
...
//cout << "tplus_measure" << t_plus_1_measure.size()<<endl;
/*
        ...
        for (n = 0; n < t_plus_1_measure.size(); n++) {
             ...
             * higher and if no close association found the probability will
